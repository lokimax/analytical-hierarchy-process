...
/**
 * Integration tests for ClientController (Authentication and User Management).
 * Tests user registration, login, logout, and profile access.
 *
 * @author Max Wick
 */
@SpringBootTest
...
public class ClientControllerTest {
    ...
    public void testCompleteUserLifecycle() throws Exception {
        ...
        String response = mockMvc.perform(post("/api/clients/login")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(loginRequest)))
                .andExpect(status().isOk())
                .andReturn()
