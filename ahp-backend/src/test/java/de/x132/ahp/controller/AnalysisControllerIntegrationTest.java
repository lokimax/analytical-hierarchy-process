...
class AnalysisControllerTest {
    ...
    void shouldCreateAnalysisSuccessfully() throws Exception {
        ...
        // When & Then
        mockMvc.perform(post("/api/projects/TestProject/analyses")
    ...
    @Test
    @WithMockUser
    @DisplayName("POST /api/projects/{projectName}/analyses - Should return 404 when project not found")
    void shouldReturn404WhenProjectNotFound() throws Exception {
        ...
        // When & Then
        mockMvc.perform(post("/api/projects/NonexistentProject/analyses")
                        .with(authentication(authentication))
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(request)))
    ...
    @Test
    @WithMockUser
    @DisplayName("POST /api/projects/{projectName}/analyses - Should return 400 when analysis name already exists")
    ...
    void shouldReturnAllAnalyses() throws Exception {
        ...
        // When & Then
        mockMvc.perform(get("/api/projects/TestProject/analyses")
                        .with(authentication(authentication)))
    ...
    @Test
    @WithMockUser
    @DisplayName("GET /api/projects/{projectName}/analyses/{analysisId} - Should return analysis by id")
    void shouldReturnAnalysisById() throws Exception {
        ...
        // When & Then
        mockMvc.perform(get("/api/projects/TestProject/analyses/1")
                        .with(authentication(authentication)))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(1))
                .andExpect(jsonPath("$.name").value("Test Analysis"));
    ...
    @Test
    @WithMockUser
    @DisplayName("GET /api/projects/{projectName}/analyses/{analysisId} - Should return 404 when analysis not found")
    void shouldReturn404WhenAnalysisNotFound() throws Exception {
        ...
        // When & Then
        mockMvc.perform(get("/api/projects/TestProject/analyses/999")
                        .with(authentication(authentication)))
                .andExpect(status().isNotFound());
    }
    ...
    @Test
    @WithMockUser
    @DisplayName("DELETE /api/projects/{projectName}/analyses/{analysisId} - Should delete analysis successfully")
    void shouldDeleteAnalysisSuccessfully() throws Exception {
        ...
        // When & Then
        mockMvc.perform(delete("/api/projects/TestProject/analyses/1")
                        .with(authentication(authentication)))
