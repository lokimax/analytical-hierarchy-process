...
public class PrioritisationService {
    ...
    public FullResultDTO calculateAHP(Prioritisation prioritisation, List<Node> startNodes) {
        ...
        List<de.x132.ahp.core.model.Node> coreStartNodes = buildHierarchyFromComparisons(
            startNodes, comparisons, nodeMap);
    ...
    private java.util.Map<String, de.x132.ahp.core.model.Node> createNodeMap(List<Comparison> comparisons) {
        ...
        for (Comparison comparison : comparisons) {
            ...
            nodeMap.putIfAbsent(parentName, de.x132.ahp.core.model.Node.builder()
                .name(parentName)
                .build());
            nodeMap.putIfAbsent(leftName, de.x132.ahp.core.model.Node.builder()
                .name(leftName)
                .build());
            nodeMap.putIfAbsent(rightName, de.x132.ahp.core.model.Node.builder()
                .name(rightName)
                .build());
        }
    ...
    private List<de.x132.ahp.core.model.Node> buildHierarchyFromComparisons(
            List<Node> startNodes, List<Comparison> comparisons,
    ...
    private de.x132.ahp.core.model.Prioritisation convertToCorePrioritisation(
        ...
        List<de.x132.ahp.core.model.Comparison> coreComparisons = comparisons.stream()
                .map(c -> convertToCoreComparison(c, nodeMap))
                .toList();
