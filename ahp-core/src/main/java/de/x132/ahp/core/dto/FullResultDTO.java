...
/**
 * Data Transfer Object representing the complete AHP calculation result.
 * Contains results for all nodes in the hierarchy.
 *
 * @author Max Wick
 */
@Data
...
public class FullResultDTO {
     ...
     */
    @Builder.Default
    private List<SolvingResultDTO> nodeResults = new ArrayList<>();
