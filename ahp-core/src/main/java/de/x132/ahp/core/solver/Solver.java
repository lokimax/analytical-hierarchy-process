...
/**
 * Interface for AHP solving algorithms. Defines methods for generating prioritizations and
 * calculating results.
 *
 * @author Max Wick
 */
public interface Solver {
  ...
  /**
   * Generates a prioritization template for a project. Creates all necessary pairwise comparisons
  ...
  /**
   * Calculates influence results (reverse dependencies) for a given node. Shows which nodes
   * influence the given node and by how much.
   *
   ...
   */
  FullResultDTO getSolvingResult(
