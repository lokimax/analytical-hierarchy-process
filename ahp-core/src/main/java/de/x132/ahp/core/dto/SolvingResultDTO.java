...
/**
 * Data Transfer Object for AHP solving results. Contains a list of single results representing
 * priorities for multiple nodes.
 *
 * @author Max Wick
 */
@Data
...
public class SolvingResultDTO {
  ...
  @Builder.Default private List<SingleResult> results = new ArrayList<>();
