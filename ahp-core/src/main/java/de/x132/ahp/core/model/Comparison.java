...
/**
 * Represents a pairwise comparison between two nodes in AHP. The comparison value indicates the
...
public class Comparison {
  ...
  /**
   * The comparison value (1-9 scale in AHP). Values > 1 mean nodeA is preferred over nodeB. Values
   * < 1 mean nodeB is preferred over nodeA. Value = 1 means equal importance.
   */
